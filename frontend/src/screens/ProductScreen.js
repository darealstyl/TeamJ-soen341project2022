          ...
          <div>
            ...
            <Col md={3}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Rating value={product.rating} text={` ${product.reviews.length} reviews`} color={'#f8e825'} />
                </ListGroup.Item>
                ...
                <ListGroup variant='flush'>
                  ...
                  <ListGroup.Item>
                    ...
                    {userInfo ? (
                      ...
                      <Message variant='secondary'>Please <Link to="/sign-in">sign in</Link> to write a review.</Message>
                    )}
                  </ListGroup.Item>
                </ListGroup>
              </Col>
